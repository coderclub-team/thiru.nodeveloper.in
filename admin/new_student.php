...
<div class="col-lg-12">
	<div class="card">
				...
				<div class="row">
					<div class="col-md-6 border-right">
						<div class="form-group">
							<label for="" class="control-label">Register Number</label>
		...
		<div class="card-footer">
			...
			<button id="btn-excel-upload" class="btn btn-info mr-2">Excel Upload</button>
...
<script>
	...
	document.getElementById("btn-excel-upload").addEventListener("click", function() {
		...
		if (file == undefined) {
			alert_toast("Please select a file first.", "danger");
			return false;
		}
		const formData = new FormData();
		formData.append("file", file);

		fetch("//103.120.179.216:3300/upload", {
				method: "POST",
				body: formData
			})
